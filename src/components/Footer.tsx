...
import { Github, MessageSquare, ShieldCheck, Terminal } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12">
          <div className="space-y-6 md:col-span-4">
            ...
            <div className="flex items-center gap-5 pt-2">
              ...
              <a href="https://discord.gg/mAjzxwSwRp" target="_blank" rel="noreferrer" className="text-zinc-400 hover:text-zinc-900 transition-colors" aria-label="Discord">
